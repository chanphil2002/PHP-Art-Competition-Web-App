...
<head>
    ...
    <title>Ongoing Competition List</title>
...
<body>
    <div>
        <strong>
            <br>
            <center>
                <h2>Ongoing Competition List</h2>
            </center><br>
        </strong>
    </div>
    <div>
        <ul class="nav nav-tabs">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="onGoingComp.php">On-going</a>
            </li>
            <li class="nav-item">
    ...
    <div class="body">
        <table class="table">
            ...
            <tbody>
                ...
                $count = 1;
                $sum = 0;
                $sql = "SELECT * FROM competition WHERE status = 'On-Going'";
