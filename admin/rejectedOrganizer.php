...
<head>
    ...
    <title>Rejected Organizer Application List</title>
    <link rel="stylesheet" href="view.css"/>
</head>
<body>
    <div>
        <strong>
            <br><center><h2>Rejected Organizer Application List</h2></center><br>
        </strong>
    </div>
    <div>
        <ul class="nav nav-tabs">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="rejectedOrganizer.php">Rejected</a>
            </li>
        </ul>
    </div>
    <div class="body">
        <table class="table">
            ...
            <tbody>
                <?php
                    $count = 1;
                    $sum = 0;
                    $sql = "SELECT * FROM organizer WHERE organizerStatus = 'Rejected'";
