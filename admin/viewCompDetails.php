		...
		<div class="form-v7-content">
			<form class="form-detail" action="#" method="post" id="myform" enctype="multipart/form-data">
                ...
                <div class="form-row">
					...
					<input type="text" name="organizerName" id="organizerName" class="input-text" value="<?php echo $organizerName ?>" <?php echo $update ?>>
				</div>
                <div class="form-row">
...
<?php 
	if (isset($_POST["approve"])){
		...
		$newOrganizer = $_POST['organizerName'];
		...
		$sql3 = "SELECT * FROM organizer WHERE organizerName = '$newOrganizer'";
