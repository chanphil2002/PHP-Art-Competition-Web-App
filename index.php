...
<body>
    ...
    <div class="container" style="max-width: 1320px">
        ...
        <a href="guest/allComp.php?category=2D" style="color:darkblue; margin-left: 900px">See more&nbsp;<i class="fa-solid fa-angle-right"></i></a>
    </div>
    ...
    <div class="container" style="max-width: 1320px">
        ...
        <a href="guest/allComp.php?category=3D" style="color:darkblue; margin-left: 900px">See more&nbsp;<i class="fa-solid fa-angle-right"></i></a>
    </div>
    ...
    <div class="container" style="max-width: 1320px">
        ...
        <a href="guest/allComp.php?category=Paintings" style="color:darkblue; margin-left: 800px">See more&nbsp;<i class="fa-solid fa-angle-right"></i></a>
    </div>
    ...
    <div class="container" style="max-width: 1320px">
        ...
        <a href="guest/allComp.php?category=Photography" style="color:darkblue; margin-left: 750px">See more&nbsp;<i class="fa-solid fa-angle-right"></i></a>
    </div>
