<footer id="footer" class="pt-4 md-5 pt-md-5 border-top bg-dark bg-opacity-75 bg-gradient px-5 pb-3">
    <div class="row">
        ...
        <div class="col-6 col-md">
            ...
            <ul class="list-unstyled text-small">
                ...
                <li><a class="text-info" href="../contactUs/contactUs.php">Contact Admin</a></li>
            </ul>
        </div>
        <div class="col-6 col-md">
            <h5>Follow Us On</h5>
            <ul class="list-unstyled text-small">
                <li><a class="text-info" href="https://www.facebook.com/Organic-X-103220925584579"> <button
                            type="button"
                            class="btn btn-outline-primary">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i
                                class="fab fa-facebook"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button>
                    </a></li> <br>
                <li><a class="text-info" href="https://www.instagram.com/organicx123/"> <button type="button"
    ...
    <div class="col-12 col-md ">
        <ul class="list-unstyled text-small text-center">
            <li><a class="text-light" href="../product/term.php">Terms and Conditions &nbsp;</a> <a
                    class="font-weight-normal text-muted">|&nbsp;</a> <a class="text-light"
                    href="../product/privacy.php">Privacy Policy</a></li>
        </ul>
    </div>
</footer>
